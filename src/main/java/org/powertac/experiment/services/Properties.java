...
/**
 * Central source of Properties read from experiment.properties
 *
 * @author John Collins
 */
...
public class Properties
{
  ...
  private String resourceName = "experiment.properties";
  ...
  private String getTourneyUrl ()
  {
    ...
    String tourneyUrl = "http://%s:8080/ExperimentScheduler/";
    ...
    try {
      ...
      e.printStackTrace();
      messages.add("Error getting Experiment Location!");
    }
